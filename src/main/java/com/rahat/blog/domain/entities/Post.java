...
//    @Enumerated(EnumType.STRING)
    ...
    public Post(UUID id, String title, String content, PostStatus status, User author, Category category, Set<Tag> tags, LocalDateTime createdAt, LocalDateTime updatedAt) {
        this.id = id;
        this.title = title;
